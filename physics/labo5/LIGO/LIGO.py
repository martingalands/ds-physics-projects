...
# lp = gwpy.signal.filter_design.lowpass(f_high, strain.sample_rate)
# hp= gwpy.signal.filter_design.highpass(25, strain.sample_rate)

# notches
notches = [gwpy.signal.filter_design.notch(line, strain.sample_rate) for line in (60,70.25, 78, 120, 127, 130, 180, 225)]
...
plt.ylabel('POST FILTRO Strain [Adim.]')
